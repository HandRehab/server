            ...
            for handLM in results.multi_hand_landmarks:
                ...
                for id, lm in enumerate(handLM.landmark):
                    ...
                    if index_finger and thumb_finger:
                        ...
                        if top_left[0] < index_finger[0] < bottom_right[0] and top_left[1] < index_finger[1] < bottom_right[
                            1]:
                            if res < 50:
                    ...
                    if (
                            (top_left[0] < success_top_left[0] < bottom_right[0] or top_left[0] < success_bottom_right[0] <
                             bottom_right[0])
                            and (top_left[1] < success_top_left[1] < bottom_right[1] or top_left[1] <
                                 success_bottom_right[1] < bottom_right[1])):
                        top_left = initial_top_left
                        bottom_right = initial_bottom_right
                        score += 1
...
if __name__ == "__main__":
    ...
    loop.run_until_complete(box_play())
